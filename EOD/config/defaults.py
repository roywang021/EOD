...
def add_opendet_config(cfg):
    ...
    _C.MODEL.ROI_HEADS.UNCERTAINTY_THR = 0.5
    _C.MODEL.ROI_HEADS.EVIDENCE_LOSS_TYPE = "ML"
    _C.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.3
    ...
    #_C.MODEL.RPN.IOU_THRESHOLDS = [0.3, 0.75]